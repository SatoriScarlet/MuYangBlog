    ...
    <div class="IntroduceMyself_text_div">
        ...
        <div class="IntroduceMyself_info_div">
            ...
            <div class="IntroduceMyself_info_text_field_div">
                ...
                非常强烈的学习欲，喜欢接触各种新事物
                有较强的学习效率和实现效率
                有良好的编程习惯，会自行审查可能出现的BUG，主动优化代码结构
                有集体荣誉感，愿意为团队的其他人分担压力
                能吃苦耐劳，加班什么的完全不虚
                脾气好，但略微有强迫症
        ...
        <div class="IntroduceMyself_info_div">
            <br>
            <div class="IntroduceMyself_info_title_div"><div class="IntroduceMyself_info_title_text_div" style="background-color: #d72f31">Warning！Warning！Warning！</div>
                <div class="AnnotationMessage_icon_div" style="right: 0;top: 0;">
                    <div class="AnnotationMessage_text_div">
                        一下按钮仅为个人测试按钮<br>
                        点击之后出现任何问题与本人无关<br>
